...
import { HomeIcon, CalendarIcon, LogOutIcon, UserIcon } from "@/components/icons"
    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-border z-10">
      <div className="max-w-lg mx-auto flex items-center justify-around py-2">
        ...
        <div>
          <button
            onClick={onLogout}
            className="flex flex-col items-center gap-1 px-6 py-2 rounded-lg text-muted-foreground hover:text-destructive transition-colors"
          >
